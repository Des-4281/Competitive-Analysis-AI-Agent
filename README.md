...
If access is not available see Example GCP Run section below.

### Example GCP Run

See `gcp_log.md` for the logs of the report generated by the AI agent. 

See `demo_log.csv` for a structured report in CSV generated from the logs. 
...
├── gcp_log.md                  # Full log of a real GCP Cloud Run Job execution
├── demo_log.csv                # Structured agent tool usage log from a real run
├── examples/
│   ├── example_run.md          # Annotated walkthrough of a local run
